...
T = TypeVar("T", bound="AttendanceDecideAbsenceResponse200")


@_attrs_define
class AttendanceDecideAbsenceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attendance_decide_absence_response_200 = cls(
            status=status,
        )

        attendance_decide_absence_response_200.additional_properties = d
        return attendance_decide_absence_response_200
