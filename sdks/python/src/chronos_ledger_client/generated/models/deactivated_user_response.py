...
T = TypeVar("T", bound="DeactivatedUserResponse")


@_attrs_define
class DeactivatedUserResponse:
    """
    Attributes:
        open_items (OpenItems): What still names a deactivated account. Deactivating changes none of it and is never
            refused because of it; calling deactivate again counts afresh.
        id (str | Unset):
        full_name (str | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        open_items = self.open_items.to_dict()
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        deactivated_user_response.additional_properties = d
        return deactivated_user_response
