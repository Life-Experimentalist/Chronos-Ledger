...
T = TypeVar("T", bound="GuestDecisionRequest")


@_attrs_define
class GuestDecisionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        guest_decision_request = cls(
            decision=decision,
        )

        guest_decision_request.additional_properties = d
        return guest_decision_request
