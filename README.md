...
| `PASSWORD_MIN_LENGTH`    | optional    | Shortest password a person may choose, default 12. Applies to the first-login change and to every account an admin or the importer creates. Refused below 8. |
